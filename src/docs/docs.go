...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/organizations/{org_id}/projects/{project_id}/archive": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/audit": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/environments": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.envNameRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/environments/{env_id}": {
            "delete": {
                "produces": [
                    "application/json"
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/flags": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.flagCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/flags/{flag_id}": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.flagUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/flags/{flag_id}/audit": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Environment name (for filtering)",
                        "name": "env",
                        "in": "query"
                    }
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/flags/{flag_id}/config": {
            "post": {
                "consumes": [
                    "application/json"
                ],
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.flagConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/sdk-keys": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.sdkKeyCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/sdk-keys/{key_id}": {
            "delete": {
                "produces": [
                    "application/json"
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/sdk-keys/{key_id}/reveal": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/organizations/{org_id}/projects/{project_id}/segments": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.segmentCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/segments/{segment_id}": {
            "get": {
                "produces": [
                    "application/json"
                ],
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.segmentUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/organizations/{org_id}/projects/{project_id}/unarchive": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "handlers.flagConfigRequest": {
            ...
            "properties": {
                ...
                "overrides": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/controllers.OverridePayload"
                    }
                },
                "rolloutEnabled": {
                    "type": "boolean"
        ...
        "handlers.segmentCreateRequest": {
            ...
            "properties": {
                ...
                "rules": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SegmentRule"
                    }
                }
            }
        },
        "handlers.segmentUpdateRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
